        ...
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                ...
                <div class="position-relative mx-auto">
                    <a href="shop.html"
                        class="btn btn-primary l border-2 border-secondary py-3 px-4 rounded-pill text-white h-100"
                        style="top: 0; right: 25%;">Belanja Sekarang
                    </a>
                </div>
            </div>
                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            <img src="{{ asset('LandingPage/img/hero-img-1.png') }}" class="img-fluid w-100 h-100 bg-secondary rounded"
                                alt="First slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Kerajinan</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="{{ asset('LandingPage/img/hero-img-2.jpg') }}" class="img-fluid w-100 h-100 rounded" alt="Second slide">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <img src="{{ asset('LandingPage/img/best-product-1.jpg') }}" class="img-fluid rounded-circle w-100" alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Keripik Singkong</a>
            ...
            <div class="testimonial-item img-border-radius bg-light rounded p-4">
                <div class="position-relative">
                    ...
                    <div class="mb-4 pb-4 border-bottom border-secondary">
                        <p class="mb-0">Produk dari UMKMMART sangat berkualitas dan pengirimannya cepat. Saya sangat puas dengan layanan mereka.</p>
                    </div>
                    <div class="d-flex align-items-center flex-nowrap">
                        <div class="bg-secondary rounded">
                            <img src="{{ asset('LandingPage/img/testimonial-1.jpg') }}" class="img-fluid rounded"
                                style="width: 100px; height: 100px;" alt="">
                        </div>
                        <div class="ms-4 d-block">
                            <h4 class="text-dark">Andi Rahmat</h4>
