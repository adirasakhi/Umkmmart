        ...
        <div class="section-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-primary my-2" style="width: 180px; margin:20px" data-toggle="modal" data-target="#myModalCreate">Tambah Product</button>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                ...
                                <table class="table table-striped table-md" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-icon btn-warning edit" data-id="{{ $product->id }}"><i class="far fa-edit"></i></button>
                                                <button class="btn btn-icon btn-danger delete-btn" data-id="{{ $product->id }}"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
