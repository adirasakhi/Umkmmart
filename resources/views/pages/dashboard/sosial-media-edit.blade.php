...
<form action="{{ url('sosial-media/update', $data->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="whatsapp" class="form-control input-sm" value="{{ $data->whatsapp }}">
    <label for="facebook" class="control-label">Facebook</label>
    <input type="text" name="facebook" class="form-control input-sm" value="{{ $data->facebook }}">
    <label for="instagram" class="control-label">Instagram</label>
    <input type="text" name="instagram" class="form-control input-sm" value="{{ $data->instagram }}">
    <label for="tiktok" class="control-label">Tiktok</label>
    <input type="text" name="tiktok" class="form-control input-sm" value="{{ $data->tiktok }}">
