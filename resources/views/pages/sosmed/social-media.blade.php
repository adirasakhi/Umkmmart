                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-end">
                                    @if (auth()->user()->role_id == 2 || !$userHasSosmedData)
                                        <button class="btn btn-primary my-2" style="width: 180px; margin:20px"
                                            data-bs-toggle="modal" data-bs-target="#myModalCreate">Tambah Akun</button>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-md" id="example">
                                        ...
                                        @foreach ($sosmed as $val)
                                            <tr>
                                                ...
                                                <td>{{ $val->tiktok }}</td>
                                                <td>
                                                    <button class="btn btn-icon btn-warning edit"
                                                        data-id="{{ $val->id }}"><i class="far fa-edit"></i></button>
                                                    <button class="btn btn-icon btn-danger delete-btn"
                                                        data-id="{{ $val->id }}"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
